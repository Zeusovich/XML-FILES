...
namespace bntu.vsrpp.dermakov.Core
{
    public class XMLLibrary
    {
        ...
        /// </summary>
        /// <param name="filePath"> Путь к файлу </param>
        /// <param name="number"> Параметр обьекта </param>
        ...
        public int AverageNumbersValue(string filePath, string name)
        {
            ...
            return averageValue/GetNumberOfElements(filePath);
        }
        ...
        public List<XmlElement> ReadDoc(string filePath)
        {
            XmlDocument xDoc = new XmlDocument();
            xDoc.Load(filePath);
            XmlElement xRoot = xDoc.DocumentElement;
        ...
        private void AddChildElement(string childName,string childText,XmlElement parentElement,XmlDocument xmlDoc)
        {
        ...
        /// <param name="saveFileName"> Новое имя </param>
        public void WriteDoc(string filePath, string saveFileName)
        {
            List<XmlElement> objects = ReadDoc(filePath);
