...
namespace bntu.vsrpp.dermakov
{
    ...
    {
        public string filePath = "E:/proga/VSRPP/bntu.vsrpp.emorozov/bntu.vsrpp.dermakov/bin/Debug/lab1_example1.xm";
        public XMLLibrary xLib = new XMLLibrary();
        ...
        {
            xLib.WriteDoc(filePath, "lab1_example1_output.xml");
        ...
        {
            ListForm listForm = new ListForm(xLib.FindIntElements(filePath), this);
            listForm.ShowDialog();
        }

        private void buttonListStrings_Click(object sender, EventArgs e)
        {
            ListForm listForm = new ListForm(xLib.FindStringElements(filePath), this);
            listForm.ShowDialog();
        }
    }
}
